...
//        EntityModelLayerRegistry.registerModelLayer(SOCKS_LAYER_SLIM, () -> slim_socks_data);
    ...
    public static boolean isRenderingInnerArmor = false;

    public static LivingEntity currentlyRenderingEntity;

    //get the model data of our sock model
    public static TexturedModelData normal_socks_data = sock_layer.getModelData(0.4f);
